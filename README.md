...
- [Kubernetes Training](#kubernetes-training)
  ...
  - [Gateway](#gateway)
  - [Istio](#istio)
    - [(Optional) Istio's Gateway and VirtualService APIs (an alternative that predates the Kubernetes Gateway API)](#optional-istios-gateway-and-virtualservice-apis-an-alternative-that-predates-the-kubernetes-gateway-api)
...
### (Optional) Istio's Gateway and VirtualService APIs (an alternative that predates the Kubernetes Gateway API)
...
Once you are done undeploy this all by running:
