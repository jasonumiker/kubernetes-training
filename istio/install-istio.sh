...
helm install istio-base istio/base -n istio-system --set defaultRevision=default --version=1.29.1
helm install istiod istio/istiod -n istio-system --wait --set global.hub=mirror.gcr.io/istio --version=1.29.1
...
helm install kiali-server -n istio-system kiali/kiali-server -f kiali-values.yaml --version=v2.24.0
